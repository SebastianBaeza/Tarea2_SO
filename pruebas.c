        ...
        *ptr = mensaje;
        ...
        if (proceso == 0 && parte == 1){
            ...
            *ptr += 1;
            ...
            mensaje++;
            write(pipe_2p[1], &mensaje, sizeof(int));
            // mensaje = mensaje * 2;
            ...
            *ptr += 1;
            ...
            mensaje++;
            write(pipe_3p[1], &mensaje, sizeof(int));
            //juegue

            int *aux = NULL;
            aux = &flag;
            *aux = 1;
        } else if (proceso == 3 && parte == 4){
            //juego
